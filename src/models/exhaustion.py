...
def simulate_exhaustion(knot):
    ...
    on a minimal knot projection for an authentic positive non-alternating knot.
    """
...
if __name__ == "__main__":
    # 12n_242 is a 12-crossing strictly positive, non-alternating knot with unknotting number 4
    k12n242 = KnotProjection("12n_242", crossings=12, unknotting_number=4)
    simulate_exhaustion(k12n242)
